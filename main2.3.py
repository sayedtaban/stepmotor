    ...
    def start_motors(self):
        ...
        if ON_PI:
            try:
                ...
                # Set GPIO warnings to False to avoid warnings
                ...
                self.append_status(f"❌ Unexpected GPIO Error: {e}")
                QMessageBox.critical(self, "GPIO Error", f"Unexpected GPIO error: {e}")
                return
